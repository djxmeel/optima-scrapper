...
if IF_IMPORT_PRODUCTS:
    ...
    OdooImport.import_products(TARGET_DATA_DIR_PATH, UPLOADED_DATA_DIR_PATH, skip_attrs_of_existing=IF_SKIP_ATTRS_OF_EXISTING, use_excel_filter=USE_EXCEL_FILTER)
